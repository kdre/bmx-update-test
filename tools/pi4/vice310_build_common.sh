...
build_circle_stdlib() {
  ...
  ./configure --raspberrypi=4 --kernel-max-size 48 \
    ...
    --opt-tls \
    --prefix arm-none-eabi- "${circle_profile_options[@]}"
  configure_circle_profile_flags
  make -j"$(nproc)"
...
set_vice310_make_args() {
  ...
  vice_cflags="-O3 -std=gnu11 -ffreestanding -nostdlib -fno-exceptions -Wno-incompatible-pointer-types -march=armv8-a -mtune=cortex-a72 -marm -mfpu=neon-fp-armv8 -mfloat-abi=hard$debug_define$release_define$diag_defines -I$VICE_SRC -I$SRC_DIR/src -I$SRC_DIR -I$SRC_DIR/third_party/common -I$NEWLIBDIR/include -I$CIRCLE_STDLIB_HOME/include -I$CIRCLE_STDLIB_HOME/libs/circle/addon -I$CIRCLE_STDLIB_HOME/libs/circle/addon/fatfs"
  vice_cxxflags="-O3 -ffreestanding -nostdlib -fno-exceptions -fcheck-new -march=armv8-a -mtune=cortex-a72 -marm -mfpu=neon-fp-armv8 -mfloat-abi=hard -std=c++11 -fno-rtti -nostdinc++$debug_define$release_define$diag_defines -I$VICE_SRC -I$SRC_DIR/src -I$SRC_DIR -I$SRC_DIR/third_party/common -I$NEWLIBDIR/include -I$CIRCLE_STDLIB_HOME/include -I$CIRCLE_STDLIB_HOME/libs/circle/addon -I$CIRCLE_STDLIB_HOME/libs/circle/addon/fatfs"
